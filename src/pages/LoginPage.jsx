  ...
  return (
    <>
      <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto h-screen lg:py-0">
        <div class="w-full rounded-lg  dark:border md:mt-0 sm:max-w-md xl:p-0 bg-neutral-900 backdrop-blur-lg dark:border-neutral-700 shadow-red-400 ">
          <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
            <a
              href="#"
              class="flex items-center justify-center mb-12 text-2xl font-semibold text-gray-900 dark:text-white"
            >
